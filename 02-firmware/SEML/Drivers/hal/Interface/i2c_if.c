...
SEML_StatusTypeDef SEML_I2C_Transmit(I2C_Handle_t *I2C_Handle, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    return (SEML_StatusTypeDef)I2C_Handle->I2C_Transmit(I2C_Handle->hi2c, DevAddress, pData, Size, Timeout);
}
/**
 * @brief i2c接收函数
 * @param[in] I2C_Handle i2c句柄
...
SEML_StatusTypeDef SEML_I2C_Receive(I2C_Handle_t *I2C_Handle, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    return (SEML_StatusTypeDef)I2C_Handle->I2C_Receive(I2C_Handle->hi2c, DevAddress, pData, Size, Timeout);
}
...
SEML_StatusTypeDef SEML_I2C_Mem_Read(I2C_Handle_t *I2C_Handle, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    return (SEML_StatusTypeDef)I2C_Handle->I2C_Mem_Read(I2C_Handle->hi2c, DevAddress, MemAddress, MemAddSize, pData, Size, Timeout);
}
...
SEML_StatusTypeDef SEML_I2C_Mem_Write(I2C_Handle_t *I2C_Handle, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    return (SEML_StatusTypeDef)I2C_Handle->I2C_Mem_Write(I2C_Handle->hi2c, DevAddress, MemAddress, MemAddSize, pData, Size, Timeout);
}
 ...
 * @retval SEML_OK 执行完成
 */
static SEML_StatusTypeDef Software_I2C_SendByte(Software_I2C_HandleTypeDef *hi2c, uint8_t _ucByte)
{
    uint8_t i, temp;
 ...
 */
static void Software_I2C_ReadByte(Software_I2C_HandleTypeDef *hi2c, uint8_t *_ucByte)
{
    uint8_t i;
    uint8_t value;
    __disable_irq();
 ...
 * @retval SEML_OK 总线应答
 */
static SEML_StatusTypeDef Software_I2C_WaitAck(Software_I2C_HandleTypeDef *hi2c, uint32_t timeout)
{
    uint8_t ack = SET;
