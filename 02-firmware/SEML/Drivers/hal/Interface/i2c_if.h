...
#define Hardware_I2C_Register(I2C_Handle, hi2c_)                                                    \
	SEML_I2C_Register(I2C_Handle, hi2c_,                                                              \
										(I2C_Transmit_t)HAL_I2C_Master_Transmit, (I2C_Receive_t)HAL_I2C_Master_Receive, \
										(I2C_Mem_Write_t)HAL_I2C_Mem_Write, (I2C_Mem_Read_t)HAL_I2C_Mem_Read)
#endif
 ...
 * @param hi2c_ i2c接口句柄
 */
#define Software_I2C_Register(I2C_Handle, hi2c_)                                                \
	SEML_I2C_Register(I2C_Handle, hi2c_,                                                          \
										(I2C_Transmit_t)Software_I2C_Transmit, (I2C_Receive_t)Software_I2C_Receive, \
										(I2C_Mem_Write_t)Software_I2C_Mem_Write, (I2C_Mem_Read_t)Software_I2C_Mem_Read)
