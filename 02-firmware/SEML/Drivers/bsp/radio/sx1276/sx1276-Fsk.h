...
/**
 * @addtogroup RegOpMode寄存器
 * @{
 */
/*!
 * RegOpMode
 */
#define RF_OPMODE_LONGRANGEMODE_MASK                0x7F    /** LoRa模式掩码 */
#define RF_OPMODE_LONGRANGEMODE_OFF                 0x00    /** LoRa模式关闭 */ // Default
#define RF_OPMODE_LONGRANGEMODE_ON                  0x80    /** LoRa模式开启 */

#define RF_OPMODE_MODULATIONTYPE_MASK               0x9F    /** 调制方案掩码 */
#define RF_OPMODE_MODULATIONTYPE_FSK                0x00    /** FSK调制 */ // Default
#define RF_OPMODE_MODULATIONTYPE_OOK                0x20    /** OKK调制 */

#define RF_OPMODE_FREQMODE_ACCESS_MASK              0xF7    /** 访问低频模式寄存器掩码 */
#define RF_OPMODE_FREQMODE_ACCESS_LF                0x08    /** 访问低频模式测试寄存器 */ // Default
#define RF_OPMODE_FREQMODE_ACCESS_HF                0x00    /** 访问高频模式测试寄存器 */

#define RF_OPMODE_MASK                              0xF8    /** 收发器状态掩码 */
#define RF_OPMODE_SLEEP                             0x00    /** 睡眠模式 */
#define RF_OPMODE_STANDBY                           0x01    /** 待机模式 */ // Default
#define RF_OPMODE_SYNTHESIZER_TX                    0x02    /** 频率合成器转换至Tx频率 */
#define RF_OPMODE_TRANSMITTER                       0x03    /** 发送模式 */
#define RF_OPMODE_SYNTHESIZER_RX                    0x04    /** 频率合成器转换至Rx频率 */
#define RF_OPMODE_RECEIVER                          0x05    /** 接收模式 */
///@} RegOpMode寄存器
