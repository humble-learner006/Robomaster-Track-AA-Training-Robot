...
void AHRS_Update(AHRS_t *AHRS)
{
	...
	AHRS->real_accel.x = Lowpass(real_accel.x, AHRS->real_accel.x, 0.6f);
	AHRS->real_accel.y = Lowpass(real_accel.y, AHRS->real_accel.y, 0.6f);
	AHRS->real_accel.z = Lowpass(real_accel.z, AHRS->real_accel.z, 0.6f);
}
