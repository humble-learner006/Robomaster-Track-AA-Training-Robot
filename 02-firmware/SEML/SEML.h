...
// 系统组件
#include "memory.h"		 /**< 内存管理模块 */
#include "message.h"	 /**< 消息模块 */
#include "debug_log.h" /**< 日志模块 */
#include "timer.h"		 /**< 软件定时器模块 */
...
// 数据结构
#include "queue.h" /**< 队列模块 */
#include "stack.h" /**< 栈模块 */
// 控制算法
#include "foc.h"		 /**< 磁场矢量控制 */
#include "DCDC.h"		 /**< 直流变换器控制 */
#include "pfc.h"		 /**< 功率因数矫正 */
#include "pll.h"		 /**< 锁相环 */
#include "chassis.h" /**< 底盘解算 */
// 通讯模块
#include "Dji_Motor.h" /**< 大疆电机通讯模块 */
#include "supercap.h"	 /**< 超级电容通讯模块 */
