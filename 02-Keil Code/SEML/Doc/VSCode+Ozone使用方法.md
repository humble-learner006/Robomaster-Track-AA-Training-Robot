...
![img](.\Pictures\VSCode+Ozone使用方法\v2-2797ea99d0d38eb9996993bb0ad77ab2_720w.webp)
...
<img src=".\Pictures\VSCode+Ozone使用方法\image-20221112160213066.png" alt="image-20221112160213066" style="zoom:80%;" />
...
![image-20221112145717063](.\Pictures\VSCode+Ozone使用方法\image-20221112145717063.png)
...
![image-20221117121323757](.\Pictures\VSCode+Ozone使用方法\image-20221117121323757.png)
...
>  **VSCode上线了一款新的插件：**
>
> ![image-20221201134906999](.\Pictures\VSCode+Ozone使用方法\image-20221201134906999.png)
>
...
- 安装VSCode，并安装以下插件：
  ...
  ![image-20221112172157533](.\Pictures\VSCode+Ozone使用方法\image-20221112172157533.png)

  ![image-20221112172208749](.\Pictures\VSCode+Ozone使用方法\image-20221112172208749.png)

  ![image-20221112172221756](.\Pictures\VSCode+Ozone使用方法\image-20221112172221756.png)

  ![image-20221112172239386](.\Pictures\VSCode+Ozone使用方法\image-20221112172239386.png)

  ![image-20221112172254809](.\Pictures\VSCode+Ozone使用方法\image-20221112172254809.png)
...
- 安装MinGW，等待界面如下：（will be deprecated soon，请注意这种方法将会在主分支发布正式版的时候删除）
  ...
  ![image-20221112172051589](.\Pictures\VSCode+Ozone使用方法\image-20221112172051589.png)

  安装好后，打开MinGW后将所有的支持包勾选，然后安装：

  ![image-20221112172348408](.\Pictures\VSCode+Ozone使用方法\image-20221112172348408.png)

  ![image-20221112172420037](.\Pictures\VSCode+Ozone使用方法\image-20221112172420037.png)

  安装完以后，将MinGW的bin文件夹添加到环境变量中的path下，按下菜单键搜索**编辑系统环境变量**打开之后：

  ![image-20221112172716320](.\Pictures\VSCode+Ozone使用方法\image-20221112172716320.png)
...
- 配置gcc-arm-none-eabi环境变量，**把压缩包解压以后放在某个地方**，然后同上，将工具链的bin添加到PATH：（will be deprecated soon，请注意这种方法将会在主分支发布正式版的时候删除）
  ...
  ![image-20221112172858593](.\Pictures\VSCode+Ozone使用方法\image-20221112172858593.png)
...
- **CubeMX生成代码**：
  ...
  ![image-20221112173534670](.\Pictures\VSCode+Ozone使用方法\image-20221112173534670.png)

  生成的目录结构如下：

  ![image-20221112174211802](.\Pictures\VSCode+Ozone使用方法\image-20221112174211802.png)
...
![image-20221113152513343](.\Pictures\VSCode+Ozone使用方法\image-20221113152513343.png)
...
![image-20221112191712534](.\Pictures\VSCode+Ozone使用方法\image-20221112191712534.png)
...
![image-20221112192133103](.\Pictures\VSCode+Ozone使用方法\image-20221112192133103.png)
...
![image-20221112192509718](.\Pictures\VSCode+Ozone使用方法\image-20221112192509718.png)

换行需要在行尾加反斜杠\\

如果新增了头文件，在`C_INCLUDES`中新增头文件所在的文件夹：

![image-20221112192610543](.\Pictures\VSCode+Ozone使用方法\image-20221112192610543.png)
...
![image-20221115215531879](.\Pictures\VSCode+Ozone使用方法\image-20221115215531879.png)
...
![image-20221112180103750](.\Pictures\VSCode+Ozone使用方法\image-20221112180103750.png)
...
![](.\Pictures\VSCode+Ozone使用方法\vscodedebug.png)

1. 变量查看窗口，包括当前调用栈（当前作用域或代码块）内的局部变量、当前文件的静态变量和全局变量。register选项卡可以查看cpu内核的寄存器数值。

2. 变量watch窗口。右键单击要查看的变量，选择watch加入查看。

   ![image-20221113131044191](.\Pictures\VSCode+Ozone使用方法\image-20221113131044191.png)
   ...
   ![image-20221113133624273](.\Pictures\VSCode+Ozone使用方法\image-20221113133624273.png)
...
1. 安装Ozone
   ...
   ![image-20221116150122397](.\Pictures\VSCode+Ozone使用方法\image-20221116150122397.png)

   这一步注意选择install a new instance（安装一个新的实例）。后续一路确认即可。

2. 安装jlink

   ![image-20221116193340770](.\Pictures\VSCode+Ozone使用方法\image-20221116193340770.png)
...
![image-20221113133904084](.\Pictures\VSCode+Ozone使用方法\image-20221113133904084.png)

选择M4内核，为了能够查看外设寄存器的值还需要svd文件。所有mcu的svd都在图中的文件夹里提供，当然你也可以使用我们仓库根目录下的文件。

![image-20221116150901418](.\Pictures\VSCode+Ozone使用方法\image-20221116150901418.png)
...
![image-20221113134252407](.\Pictures\VSCode+Ozone使用方法\image-20221113134252407.png)

选择构建之后生成的.elf文件（在项目文件夹下的build中）。这是调试器专用的文件格式，对其内容感兴趣可以自行搜索细节。此外ozone还支持.bin .hex .axf（最后一个是amr-cc，也就是keil的工具链会生成的）等格式。

![image-20221113134605331](.\Pictures\VSCode+Ozone使用方法\image-20221113134605331.png)
...
![image-20221119174445067](.\Pictures\VSCode+Ozone使用方法\image-20221119174445067.png)
...
![](.\Pictures\VSCode+Ozone使用方法\ozone.png)
...
2. 变量watch窗口，这里的变量不会实时更新，只有在暂停或遇到断点的时候才会更新。若希望实时查看，在这里右键选择需要动态查看的变量，选择Graph，他就会出现在**窗口8**的位置。
   ...
   ![image-20221119173731119](.\Pictures\VSCode+Ozone使用方法\image-20221119173731119.png)

   如果是一个结构体，你可以为整个结构体都进行刷新率的配置，不需要手动一个个修改。**或直接右键点击窗口**，将refresh打勾：

   ![image-20221119173918340](.\Pictures\VSCode+Ozone使用方法\image-20221119173918340.png)
...
- **变量动态查看（可视化）**
  ...
  - 如果当前文件没有你要的变量，你想查看项目中的其他文件夹，在view-> source files中可以打开该项目所有的源文件，双击可以打开源文件。
    ...
    ![image-20221113142448939](.\Pictures\VSCode+Ozone使用方法\image-20221113142448939.png)
...
![image-20221116152032104](.\Pictures\VSCode+Ozone使用方法\image-20221116152032104.png)
...
![image-20221119222946103](.\Pictures\VSCode+Ozone使用方法\image-20221119222946103.png)
...
![image-20221119223148604](.\Pictures\VSCode+Ozone使用方法\image-20221119223148604.png)
...
![image-20230723132711865](.\Pictures\VSCode+Ozone使用方法\image-20230723132711865.png)
