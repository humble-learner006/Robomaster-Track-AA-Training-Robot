...
//    870000000,        // RFFrequency
    LoRa_FREQENCY,		// 射频频率
    20,               // 功率
    8,                // 信号带宽 [0: 7.8kHz, 1: 10.4 kHz, 2: 15.6 kHz, 3: 20.8 kHz, 4: 31.2 kHz,
                      // 5: 41.6 kHz, 6: 62.5 kHz, 7: 125 kHz, 8: 250 kHz, 9: 500 kHz, other: Reserved]
    7,                // 扩频因子 [6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]
    2,                // 编码率 [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
    true,             // 校验位 [0: OFF, 1: ON]
    false,            // 隐式header [0: OFF, 1: ON]
    1,                // 隐式header [0: Continuous, 1 Single]
    0,                // 跳频使能 [0: OFF, 1: ON]
...
//    if( LoRaSettings.RFFrequency > 860000000 )	//2019
